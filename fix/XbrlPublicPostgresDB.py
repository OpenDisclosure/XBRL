...
class XbrlPostgresDatabaseConnection(SqlDbConnection):
    ...
    def insertAccession(self, rssItem):
        ...
        if rssItem is None:
            ...
            table = self.getTable('entity', 'entity_pk', 
                                  ('entity_id',
                                   'legal_entity_number',
                                   'file_number',
                                  ...
                                  ((int(rssItemGet("cikNumber")) or int(entityInfo.get("cik")),
                                    LEI, 
                                    ...
                                    None, #countryOfState.get(entityInfo.get("business-address.state")),
                                    ...
                                    None, #countryOfState.get(entityInfo.get("mail-address.state")),
            ...
            if any ('former-conformed-name' in key for key in entityInfo.keys()):
                self.getTable('entity_name_history', None, 
