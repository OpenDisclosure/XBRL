...
CREATE TABLE entity
(
  entity_pk integer NOT NULL DEFAULT nextval('seq_entity'::regclass),
  entity_id integer NOT NULL DEFAULT (-1),
  entity_code character varying,
  authority_scheme character varying,
  entity_name character varying NOT NULL,
  file_name character varying(30)[],
  legal_entity_number character varying(30), -- Legal Entity Number (LEI)
  file_number character varying(30), -- An authority's filing system internal number
  reference_number character varying(30), -- An authority's external code for an entity filing a submission (e.g., SEC CIK code)
  tax_number character varying(30), -- The tax authority's number for the entity based on its location
  standard_industry_code integer NOT NULL DEFAULT (-1), -- Standard industrial classification code provided with the filing when submitted to the regulatory authority
  legal_state character varying, -- The state (or country) in which the entity is legally registered
  phone character varying, -- Telephone number
  phys_addr1 character varying, -- Physical address, line 1
  phys_addr2 character varying, -- Physical address, line 2
  phys_city character varying, -- Physical address, city
  phys_state character varying, -- Physical address, state
  phys_zip character varying, -- Physical address, postal zip code
  phys_country character varying, -- Physical address, country
  mail_addr1 character varying, -- Mail address, line 1
  mail_addr2 character varying, -- Mail address, line 2
  mail_city character varying, -- Mail address, city
  mail_state character varying, -- Mail address, state
  mail_zip character varying, -- Mail address, zip
  mail_country character varying, -- Mail address, country
  fiscal_year_end character varying(6), -- The month-day of fiscal year end
  filer_category character varying, -- Authority's classification of filer
  public_float double precision, -- Public float
  trading_symbol character varying, -- Ticker symbol for stock trading
  CONSTRAINT entity_pkey PRIMARY KEY (entity_pk)
)
WITH (
  OIDS=FALSE
);
...
COMMENT ON COLUMN entity.standard_industry_code IS 'Standard industrial classification code provided with the filing when submitted to the regulatory authority';
...
(
  entity_name_history_id integer NOT NULL DEFAULT nextval('entity_name_history_entity_name_history_id_seq'::regclass),
  entity_id integer NOT NULL,
  accession_id integer NOT NULL,
  entity_name character varying,
  date_changed date,
...
ALTER TABLE entity_name_history
  OWNER TO postgres;
